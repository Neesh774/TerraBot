...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        try {
            if (!message.member.hasPermission("BAN_MEMBERS") && !ownerID .includes(message.author.id)) return message.channel.send({content: "**You Dont Have The Permissions To Ban Users! - [BAN_MEMBERS]**"});
