...
module.exports = {
	...
	run: async (client, message, args) => {
		...
		try {
			if (!message.member.hasPermission('BAN_MEMBERS') && !config.neesh.includes(message.author.id)) return message.reply({ content: '**You Dont Have The Permissions To Ban Users! - [BAN_MEMBERS]**' });
